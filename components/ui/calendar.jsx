  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: "flex",
        head_cell: "text-zinc-500 rounded-md w-9 font-medium text-[0.8rem] dark:text-zinc-400",
        ...
        day: cn(buttonVariants({ variant: "ghost" }), "h-9 w-9 p-0 font-normal aria-selected:opacity-100 font-semibold"),
        day_selected:
